  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error("Please fill in all fields and select a rating", {
        description:
          "All fields including breed selection are required to submit feedback.",
      });
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="w-full max-w-[95vw] sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-[#3d6c58]">
            Share Your Feedback
          </DialogTitle>
          <DialogDescription>
            We&apos;d love to hear your thoughts about Triple A Gamefarm. Your
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-[#3d6c58]">
                Name
              </Label>
              <Input
                id="name"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Breed Field */}
            <div className="space-y-2">
              <Label htmlFor="breed" className="text-[#3d6c58]">
                Which breed did you order?
              </Label>
              <Select
              ...
              >
                <SelectTrigger className="border-[#A8D5BA] focus:border-[#3d6c58] focus:ring-[#3d6c58] transition-colors">
                  <SelectValue
                    placeholder={
                      isLoadingBreeds ? "Loading breeds..." : "Select a breed"
                    }
                  />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="message" className="text-[#3d6c58]">
              Message
            </Label>
            <Textarea
              id="message"
