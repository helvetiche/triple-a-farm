      ...
      try {
        ...
        if (response.ok) {
          ...
          if (data.data && data.data.length > 0) {
            ...
            const formattedTestimonials = data.data.map(
              (review: Testimonial) => ({
            ...
            console.log(
              " Replacing fallback testimonials with database data..."
            );
            ...
            console.log(
              " No published reviews found in database, using fallback"
            );
          }
        } else {
