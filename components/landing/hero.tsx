...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative h-screen overflow-hidden">
      ...
      >
        <div
          className={`${isMobile ? "px-6 w-full" : "pl-44 lg:pl-44 pr-10 w-2/5 lg:w-1/2"}`}
        >
          <motion.div
            className="space-y-1"
          ...
          >
            ...
            >
              Magtiwala sa pinakamahusay na breeding program! Mga world-class na
              manok na siguradong pampanalo. Samahan mo kami sa tagumpay!
            </motion.p>
