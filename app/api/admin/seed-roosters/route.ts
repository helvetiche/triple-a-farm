...
const sampleBreeds = [
  {
    name: "Lemon",
    description:
      "A popular gamefowl breed known for its lemon-colored plumage and fighting prowess.",
  ...
  },
  {
    name: "Golden Boy",
    description:
      "A striking golden-colored breed with excellent fighting abilities and stamina.",
  ...
  },
  {
    name: "Sweater",
    description:
      "A well-known breed famous for its sweater-like color pattern and winning record.",
...
const sampleRoosters = [
  // Lemon Roosters
  {
    ...
    health: "excellent",
    description:
      "A prime Lemon rooster with exceptional fighting lineage. Shows great potential in the pit.",
    images: [],
  ...
  },
  {
    ...
    health: "good",
    description:
      "Young Lemon rooster showing great speed and agility. Perfect for breeding.",
    images: [],
  ...
  // Golden Boy Roosters
  {
    ...
    health: "excellent",
    description:
      "Champion Golden Boy with proven track record. Excellent fighter and breeder.",
    images: [],
  ...
  },
  {
    ...
    health: "excellent",
    description:
      "Powerful Golden Boy with exceptional strength and fighting instinct.",
    images: [],
  ...
  // Sweater Roosters
  {
    ...
    health: "excellent",
    description:
      "Premium Sweater rooster with championship bloodline. Top-tier fighter.",
    images: [],
...
async function clearExistingData() {
  ...
  try {
    ...
    const breedDeletePromises = breedsSnapshot.docs.map((doc) =>
      doc.ref.delete()
    );
