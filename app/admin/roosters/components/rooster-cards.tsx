    ...
    <>
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {roosters.map((rooster, index) => (
          <Card
            key={rooster.id}
            className="border-[#3d6c58]/20 hover:border-[#3d6c58]/40 transition-colors"
          >
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <CardTitle className="text-lg text-[#1f3f2c]">
                    {rooster.id}
                  </CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="group relative aspect-square overflow-hidden bg-gray-100">
                ...
                {rooster.status === "Available" && (
                  <div className="absolute top-2 right-2">
                    <Badge className="bg-[#3d6c58] text-white">Available</Badge>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-[#1f3f2c]">
                    {rooster.age}
                  </span>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between pt-2 border-t border-[#3d6c58]/20">
                ...
                <span className="text-lg font-bold text-[#1f3f2c]">
                  ₱{rooster.price}
                </span>
              </div>
