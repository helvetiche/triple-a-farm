...
export const mockInventoryItems: InventoryItem[] = [
  ...
  },
  {
    ...
    status: "low",
    description:
      "Essential vitamin supplements for gamefowl health and immunity boost.",
    price: 120.0,
  ...
  },
  {
    ...
    status: "critical",
    description:
      "Broad-spectrum antibiotics for treating bacterial infections in gamefowl.",
    price: 280.0,
  ...
  },
  {
    ...
    status: "low",
    description:
      "Industrial-grade disinfectant for maintaining hygienic farm conditions.",
    price: 65.0,
  ...
  },
  {
    ...
    status: "critical",
    description:
      "Effective deworming medication for internal parasite control.",
    price: 95.0,
    location: "Storage Room B - Shelf 2",
