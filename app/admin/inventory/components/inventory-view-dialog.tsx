...
export function InventoryViewDialog({
  ...
  const stockPercentage = item.maxStock
    ...
    : 100;
  const isLowStock = item.status === "critical" || item.status === "low";
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div>
                ...
                <DialogDescription>
                  Item ID: {formatInventoryDisplayId(item)}
                </DialogDescription>
              </div>
            </div>
          </div>
        ...
        <ScrollArea className="h-[400px] w-full pr-4">
          <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <p className="text-md font-semibold text-[#1f3f2c]">
                        {item.lastRestocked}
                      </p>
                    </div>
                    {item.expiryDate && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {item.locationName && (
                  <div className="space-y-3">
                    ...
                    <div className="text-md font-semibold text-[#1f3f2c] bg-green-50 px-3 py-2  border border-green-200">
            ...
            {item.description && (
              <div className="bg-white border border-gray-200 p-6">
                <h3 className="text-md font-semibold text-[#1f3f2c] mb-4">
                  Description
                </h3>
                <div className="bg-green-50  p-4 border border-gray-200">
