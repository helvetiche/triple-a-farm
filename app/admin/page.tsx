              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="min-w-0">
                  {isLoading ? (
                    ...
                    <>
                      <h1 className="text-2xl sm:text-3xl font-bold text-[#1f3f2c]">
                        Dashboard
                      </h1>
                      <p className="text-[#4a6741] text-sm sm:text-base">
                        Farm operational status and key metrics
                      </p>
                    </>
                  )}
                </div>
                  ...
                  <CardContent className="space-y-3">
                    {isLoading ? (
                      ...
                      <>
                        <Button
                          asChild
                          className="w-full justify-start bg-[#3d6c58] hover:bg-[#4e816b]"
                        >
                    ...
                    <div className="min-w-0">
                      {isLoading ? (
                        ...
                        <>
                          ...
                          <CardDescription>
                            Premium roosters available for sale
                          </CardDescription>
                        </>
                      )}
                    </div>
                      ...
                      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {featuredRoosters.map((rooster, index) => (
                          ...
                          >
                            ...
                            <p className="font-bold text-[#3d6c58]">
                              ₱{parseInt(rooster.price).toLocaleString()}
                            </p>
                          </div>
                        ))}
                      </div>
                ...
                <CardHeader>
                  {isLoading ? (
                    ...
                    <>
                      ...
                      <CardDescription>
                        Latest farm operations and updates
                      </CardDescription>
                    </>
                  )}
                </CardHeader>
