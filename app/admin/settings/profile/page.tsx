              ...
              <div className="grid gap-6 lg:grid-cols-3">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="email"
                        type="email"
                        placeholder="manager@tripleagamefarm.com"
                        className="border-[#3d6c58]/20"
                      />
                    </div>
                ...
                <Card className="border-[#3d6c58]/20 lg:col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Details about your farm operation
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="farmLocation"
                          placeholder="Batangas, Philippines"
                          className="border-[#3d6c58]/20"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        id="specialization"
                        placeholder="Gamefowl breeding, Kelso, Sweater, Roundhead"
                        className="border-[#3d6c58]/20"
                      />
                    </div>
                  </CardContent>
