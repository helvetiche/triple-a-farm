  ...
  const fetchReviews = async (retryCount = 0, isRefresh = false) => {
    try {
      ...
      if (retryCount < 3 && err?.message?.includes("Failed to fetch")) {
        setTimeout(
          () => fetchReviews(retryCount + 1, isRefresh),
          1000 * (retryCount + 1)
        );
        return;
      }
                          ...
                          {[
                            ...
                            >
                              ...
                              <div className="flex items-center">
                                ...
                                <span
                                  className={`text-sm ${trend.positive === true ? "text-green-600" : trend.positive === false ? "text-red-600" : "text-gray-600"}`}
                                >
                                  {trend.change > 0 ? "+" : ""}
                                  {trend.change}
                                </span>
                        ...
                        {[
                          ...
                          >
                            <div className="flex items-center justify-between mb-2">
                              <h3 className="font-semibold text-[#1f3f2c]">
                                {breed.breed}
                              </h3>
        ...
        <DialogContent className="max-w-2xl" style={{ borderRadius: 0 }}>
          ...
          {selectedReview && (
            <div className="space-y-4">
              ...
              <div>
                <p className="text-sm font-medium text-[#4a6741] mb-2">
                  Rating
                </p>
                <div className="flex items-center">
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-2xl" style={{ borderRadius: 0 }}>
          <DialogHeader style={{ borderRadius: 0 }}>
            ...
            <DialogDescription>Modify review information</DialogDescription>
          </DialogHeader>
          {editingReview && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
      ...
      <Dialog open={isPublishDialogOpen} onOpenChange={setIsPublishDialogOpen}>
        <DialogContent className="max-w-md" style={{ borderRadius: 0 }}>
          <DialogHeader style={{ borderRadius: 0 }}>
            ...
            <DialogDescription>
              This review will be displayed on the landing page testimonials
              section.
            </DialogDescription>
          </DialogHeader>
          {selectedReview && (
      ...
      >
        <DialogContent className="max-w-md" style={{ borderRadius: 0 }}>
          <DialogHeader style={{ borderRadius: 0 }}>
            ...
            <DialogDescription>
              This review will no longer be displayed on the landing page
